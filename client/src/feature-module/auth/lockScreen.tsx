...
import { all_routes, auth_routes} from "../router/all_routes";
      ...
      <div className="d-flex flex-column justify-content-between vh-100">
        ...
        <div className="card">
          <div className="card-body p-4">
            ...
            <Link  to={all_routes.noteList} className="btn btn-primary w-100">
              Login
            </Link>
          </div>
        </div>
        <div className="p-4 text-center">
          ...
          <div className="p-2 text-center">
            <p className="mb-0 ">Copyright © Cloud Notes</p>
          </div>
        </div>
      </div>
    </form>
