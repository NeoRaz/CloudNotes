                                                    ...
                                                    <tr>
                                                        <td role="modules-container"
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                ...
                                                                data-muid="52d40637-2114-49c2-96ae-e69a80758d14"
                                                                data-mc-module-version="2019-10-22">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:18px 10px 18px 19px; line-height:29px; text-align:inherit;"
                                                                            height="100%" valign="top" bgcolor=""
                                                                            role="module-content">
                                                                            <div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: inherit">
                                                                                    Dear {{$details['name']}},</div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: inherit">
                                                                                    <br>
                                                                                    We have received a request to reset
                                                                                    your password. You may reset your
                                                                                    Account Password by clicking on the
                                                                                    link below:
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                data-muid="d669094b-13f5-4c40-b1d8-f83418acd407">
                                                                <tbody>
                                                                    <tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <a href="{{$details['resetPassword']}}"
                                                                                                style="background-color:#c2062b; border:2px solid #fffefe; border-color:#fffefe; border-radius:25px; border-width:2px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 18px 12px 18px; text-align:center; text-decoration:none; border-style:solid;"
                                                                                                target="_blank">Reset
                                                                                                Password</a>
                                                                                        </td>
                                                                                    </tr>
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                border="0" cellpadding="0" cellspacing="0" width="100%"
                                                                style="table-layout: fixed;"
                                                                data-muid="d711674e-b9b1-4854-aa61-69817016a445"
                                                                data-mc-module-version="2019-10-22">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:18px 10px 18px 19px; line-height:22px; text-align:inherit;"
                                                                            height="100%" valign="top" bgcolor=""
                                                                            role="module-content">
                                                                            <div>
                                                                                <div
                                                            ...
                                                            <table class="module" role="module" data-type="divider"
                                                                border="0" cellpadding="0" cellspacing="0" width="100%"
                                                                style="table-layout: fixed;"
                                                                data-muid="a698ee1e-08a7-4d10-b301-56865a2f6d9d">
                                                                <tbody>
                                                                    <tr>
                                                            ...
                                                            <table class="module" role="module" data-type="text"
                                                                border="0" cellpadding="0" cellspacing="0" width="100%"
                                                                style="table-layout: fixed;"
                                                                data-muid="2af2e38f-1605-4c87-97b4-667190a1d8c5"
                                                                data-mc-module-version="2019-10-22">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding:18px 10px 18px 19px; line-height:22px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <p>This is an automatically
                                                                                        generated email. Please do not
