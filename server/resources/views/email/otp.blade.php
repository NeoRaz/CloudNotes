                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:18px 10px 18px 19px; line-height:29px; text-align:inherit;"
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div
                                                                                    style="font-family: inherit; text-align: inherit">
                                                                                    <span style="color: #000000">We hope
                                                                                        you are doing great! Here’s
                                                                                        the One Time Password (OTP) for
                                                                                        you to login securely: </span>
                                                                                </div>
                                                                                <div
                                                                                    style="font-family: inherit; text-align: inherit">
                                                                                    <br>
                                                                                ...
                                                                                <div
                                                                                    style="font-family: inherit; text-align: inherit; text-align: center">
                                                                                    <span
                                                                                        style="font-size: 36px">{{$details['otp']}}</span>
                                                                                </div>
                                                                                <div></div>
                                                                            </div>
                                                                        </td>
